...
public class reqPickupMission {

	private String	Json;

	public reqPickupMission() {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("f", Info.tagSyncPickupMission));
	...
	public void savePickupMission() {
		...
		LiveData.PickupMission = gson.fromJson(getJson(), listType);
