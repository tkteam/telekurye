...
public class MultipartPost {
	...
	public String send(String urlString) throws Exception {
		...
		try {
		    ...
		    if(dos != null) try { dos.close(); } catch(IOException e) { e.printStackTrace(); Mint.logException(e); }
		    if(is  != null) try { is .close(); } catch(IOException e) { e.printStackTrace(); Mint.logException(e); }
		}
